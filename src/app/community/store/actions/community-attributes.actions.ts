...
export const ADD_COMMUNITY_OBJECT_ATTRIBUTES =
  '[CommunityAttributes]ADD_COMMUNITY_OBJECT_ATTRIBUTES';
...
export const ADD_GEOSERVICE = 'ADD_GEOSERVICE';
...
export class AddGeoService implements Action {
  readonly type = ADD_GEOSERVICE;
  constructor(public payload: GeoService[]) {}
}
...
export class CommunityInitialize implements Action {
  ...
  constructor(public payload: Community) {
    console.log('action payload ahh ', payload);
  }
}
